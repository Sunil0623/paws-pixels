				...
				<div class="formbg-outer">
					<div class="formbg">
						<div class="formbg-inner padding-horizontal--48">
							...
							<form id="stripe-register" action="UserRegistrationDb.jsp"
								...
								<div class="field padding-bottom--24">
									<label for="phone-number">Phone Number</label> <input
										type="tel" id="phonenumber" name="phonenumber" id="phonenumber">
								</div>
								<div class="field padding-bottom--24">
								...
								<div class="footer-link padding-top--24">
									<span>Already have an account? <a href="UserLogin.jsp">Login</a></span>
									<div
					...
					<div class="footer-link padding-top--24">
						<div
							class="listing padding-top--24 padding-bottom--24 flex-flex center-center">
							<span><a href="#">Privacy</a></span> <span><a href="#">Terms
									&amp; Conditions</a></span>
						</div>
					</div>
				</div>
